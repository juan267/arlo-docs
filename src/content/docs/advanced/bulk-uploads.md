...
1. **[Exportaciones](/advanced/exports/)** - Extraer datos de Arlo
2. **[Configuración de finca](/getting-started/farm-setup/)** - Configuración inicial
3. **[Catálogo de insumos](/supplies/catalog/)** - Después de importar
