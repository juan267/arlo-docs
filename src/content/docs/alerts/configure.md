...
1. **[Alertas con IA](/alerts/ai-alerts/)** - Deja que la IA sugiera configuraciones
2. **[Configuración de finca](/alerts/farm-settings/)** - Ajusta parámetros globales
3. **[Gestionar notificaciones](/alerts/manage/)** - Administra las alertas recibidas
