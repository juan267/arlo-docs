...
1. **[Configurar alertas](/alerts/configure/)** - Crea tu primera alerta
2. **[Alertas con IA](/alerts/ai-alerts/)** - Usa el asistente para configuración inteligente
3. **[Configuración de finca](/alerts/farm-settings/)** - Ajusta parámetros globales
