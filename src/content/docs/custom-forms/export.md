...
1. **[Crear nuevos formularios](/custom-forms/create/)** - Diseña formularios para otros procesos
2. **[Análisis con IA](/analysis/ai-analysis/)** - Usa IA para interpretar tus datos
3. **[Reportes ejecutivos](/analysis/executive-reports/)** - Genera informes para stakeholders
