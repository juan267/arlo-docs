...
1. **[Configura bodegas](/supplies/configuration/)** - Define ubicaciones de almacenamiento
2. **[Registra proveedores](/supplies/providers/)** - Tus fuentes de insumos
3. **[Crea el catálogo](/supplies/catalog/)** - Productos con unidades y conversiones
4. **[Registra tu primera entrada](/supplies/entries/)** - Comienza a controlar inventario
