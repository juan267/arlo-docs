...
description: A step-by-step guide to start using Arlo Agro in your first 7 days, from basic setup to your first complete cycle.
---

This guide takes you day by day through key activities to get Arlo running on your farm. By the end of the week, you'll have all basic modules working with real data captured.
...
:::tip[Recommendation]
Before inviting users, have a list ready with names, emails, and assigned roles. This makes the process faster.
:::
...
4. Define alerts with critical thresholds
...
With foundations in place, next week focus on:

1. **Establish sanitation routine**: Schedule consistent weekly routes
2. **Complete field cycle**: Log all work until closure
3. **Configure harvest module** (if applicable to the season)
4. **Explore advanced reports**: Sanitation maps, cost analysis
...
- [ ] One entry and exit recorded

---

## Need Help?

If you encounter difficulties during your first week:

- Review specific documentation for each module in the sidebar
- Each section includes detailed guides and best practices
- For technical support, contact the Arlo team

:::tip[Gradual progress]
Don't try to use all modules intensively from day one. It's better to master one before moving to the next. Most farms start with Sanitation or Field Tasks and add modules gradually.
:::
