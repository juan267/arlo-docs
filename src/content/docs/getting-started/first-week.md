...
description: Una guía paso a paso para comenzar a usar Arlo Agro en los primeros 7 días, desde la configuración básica hasta tu primer ciclo completo.
---

Esta guía te lleva día a día a través de las actividades clave para poner en marcha Arlo en tu finca. Al final de la semana, tendrás todos los módulos básicos funcionando y datos reales capturados.
...
:::tip[Recomendación]
Antes de invitar usuarios, ten lista una lista con nombres, correos y roles asignados. Esto hace el proceso más rápido.
:::
...
4. Define alertas con umbrales críticos
...
2. Selecciona una labor
3. Haz clic en **Agregar Log**
...
4. El sistema actualizará el inventario automáticamente
...
### Planificar la Semana 2

Con los fundamentos en su lugar, la próxima semana enfócate en:

1. **Establecer rutina de sanidad**: Programa rutas semanales consistentes
2. **Completar el ciclo de labores**: Registra todo el trabajo hasta el cierre
3. **Configurar módulo de cosecha** (si aplica a la temporada)
4. **Explorar reportes avanzados**: Mapas de sanidad, análisis de costos
...
- [ ] Una entrada y salida registradas

---

## ¿Necesitas Ayuda?

Si encuentras dificultades durante tu primera semana:

- Revisa la documentación específica de cada módulo en el menú lateral
- Cada sección incluye guías detalladas y mejores prácticas
- Para soporte técnico, contacta al equipo de Arlo

:::tip[Progreso gradual]
No intentes usar todos los módulos intensivamente desde el día uno. Es mejor dominar uno antes de pasar al siguiente. La mayoría de fincas comienzan con Sanidad o Labores y agregan módulos gradualmente.
:::
